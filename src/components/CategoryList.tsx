...
const CategoryList = async () => {
  ...
  return (
    <div className="py-6 px-6 md:px-8 lg:px-16 xl:px-32 2xl:px-64 text-sm mt-24">
      <div className="flex md:justify-start md:items-center md:gap-8 bg-[#f6f6f6] py-8 overflow-x-auto scrollbar-hide snap-x snap-mandatory md:pl-8">
        {cats.items.map((item) => (
          <Link
